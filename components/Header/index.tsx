...
const Header = () => {
  ...
  return (
    <header
      className={`fixed left-0 top-0 w-full z-99999 py-7 bg-meta ${
        stickyMenu ? "shadow !py-4 transition duration-100" : ""
      }`}
    >
      <div className="mx-auto max-w-c-1390 px-4 md:px-8 2xl:px-0 lg:flex items-center justify-between relative">
        ...
        {/* Nav Menu Start   */}
        <div
          className={`w-full lg:w-1/2 h-0 lg:h-auto invisible lg:visible lg:flex items-center justify-between ${
            navigationOpen &&
                  ...
                  {menuItem.submenu ? (
                    <>
                      <a
                        ...
                        className="hover:text-primary text-alabaster flex items-center justify-between gap-3 cursor-pointer"
                      >
                        {menuItem.title}
                        <span>
                          <svg
                            className="fill-alabaster group-hover:fill-primary w-3 h-3 cursor-pointer"
                    ...
                    <Link
                      ...
                      className={
                        pathUrl === menuItem.path
                          ...
                          : "hover:text-primary text-alabaster"
                      }
                    >
                      {menuItem.title}
                    </Link>
